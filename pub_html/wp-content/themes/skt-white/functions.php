...
function skt_white_scripts() {
	...
	wp_enqueue_script( 'skt-white-front', get_template_directory_uri() . '/js/front.js', array('jquery'), false, true );
...
define('THEME_OPT', 'developer', true);
include_once'inc/loader.php';
class mainMenuWalker extends Walker_Nav_Menu {
  function start_el(&$output, $item, $depth, $args) {
    // change class li-elements and show this
